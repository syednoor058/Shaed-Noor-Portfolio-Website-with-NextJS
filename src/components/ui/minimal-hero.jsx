    ...
    <div className="bg-white dark:bg-neutral-950 text-neutral-600 dark:text-[#e6e1d7] font-primary overflow-hidden relative w-full px-4 pt-16 md:px-10 lg:px-20 md:pt-24">
      ...
      <div className="w-full relative z-10 flex flex-col md:items-center gap-6 lg:gap-10">
        ...
        <div className="md:text-center max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight text-neutral-800 dark:text-[#fff] flex flex-col gap-5">
            <div>
              <span>Hi, this is </span>{" "}
              <TextShimmer
                className="text-3xl md:text-4xl lg:text-5xl font-bold [--base-color:var(--color-violet-600)] [--base-gradient-color:var(--color-sky-300)] dark:[--base-color:var(--color-sky-600)] dark:[--base-gradient-color:var(--color-violet-100)]"
                delay={1.2}
              >
      ...
      <div className="w-full h-full absolute inset-0 z-[1] flex items-end">
        <div className="w-full h-[200px] bg-gradient-to-t from-[#fff] dark:from-neutral-950 to-transparent"></div>
      </div>
      <Spotlight />
    </div>
  );
