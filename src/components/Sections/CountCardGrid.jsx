...
export default function CountCardGrid() {
  ...
  const shapeColor1 = resolvedTheme === "dark" ? "#A3E635" : "#beF264";
  const shapeColor2 = resolvedTheme === "dark" ? "#06b6d4" : "#67e8f9";
  const shapeColor3 = resolvedTheme === "dark" ? "#7C3AED" : "#C4B5FD";
  const shapeColor4 = resolvedTheme === "dark" ? "#d53f8c" : "#f9a8d4";
