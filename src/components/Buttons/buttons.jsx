...
export function SecondaryButton({ text, url, icon, className, small = false }) {
  return (
    <Link
      href={url}
      className={cn(
        "flex text-neutral-800 dark:text-white border border-neutral-800 dark:border-white transition-colors duration-300 rounded-xs justify-center items-center overflow-hidden",
        className
      )}
    >
      <GlareHover
