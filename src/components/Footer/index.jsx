...
export default function Footer() {
  return (
    <>
      <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 px-4 md:px-10 lg:px-16 py-10 lg:py-20 bg-neutral-50 dark:bg-[#050505]">
        <div className="lg:w-[50%] flex flex-col gap-10 lg:items-stretch lg:justify-between">
          <div className="flex flex-col gap-2">
            ...
            <h4 className="text-lg md:text-xl lg:text-2xl font-bold text-neutral-800 dark:text-white leading-tight mt-2">
          ...
          <div className="w-full flex flex-row gap-6">
            <div className="w-[30%] font-bold text-neutral-800 dark:text-neutral-100">
              Quick Links:
            </div>
      ...
      <div className="py-5 w-full flex flex-col lg:flex-row gap-2 justify-center items-center bg-white dark:bg-black">
